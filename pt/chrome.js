...
(function () {
  ...
  '<header class="nav"><div class="wrap nav__in">' +
      ...
      '<li class="nav__item">' +
        ...
        '<div class="nav__menu nav__menu--mega">' +
          ...
          '<div class="nav__mega-blocks">' +
            ...
            '</a>' +
            '<a class="nav__mega-block nav__mega-block--int" href="' + ROOT + 'integracoes/">' +
              '<span class="nav__mega-block__lava" aria-hidden="true"></span>' +
    ...
    '</ul>' +
    '<a class="btn btn--primary nav__cta-desktop" href="' + demo + '">Pedir demonstração</a>' +
  ...
  '<footer class="footer"><div class="wrap">' +
    '<div class="footer__in">' +
      '<div class="footer__brand">' +
        ...
        '<iframe class="footer__map" src="https://maps.google.com/maps?q=Edificio%20Angels%2C%20Carrer%20del%20Port%2013%2C%2046024%20Valencia&z=16&output=embed" title="Localização de Solved — Edificio Angels, Valencia" loading="lazy" referrerpolicy="no-referrer-when-downgrade" allowfullscreen></iframe>' +
      ...
      '<div class="footer__col">' +
        ...
        '<ul>' +
          ...
          '<li><a href="' + ROOT + 'checklists-digitais/">Registos/Checklists</a></li>' +
          '<li><a href="' + ROOT + 'gestao-de-incidentes/">Gestão de ocorrências</a></li>' +
          '<li><a href="' + ROOT + 'gestao-documental/">Gestão documental</a></li>' +
          '<li><a href="' + ROOT + 'gestao-de-ativos/">Gestão de ativos</a></li>' +
          '<li><a href="' + ROOT + 'dashboards/">Dashboard</a></li>' +
          '<li><a href="' + ROOT + 'ia/">IA</a></li>' +
          '<li><a href="' + ROOT + 'integracoes/">Integrações</a></li>' +
          '<li><a href="' + ROOT + 'casos-de-sucesso/">Casos de sucesso</a></li>' +
          '<li><a href="' + ROOT + 'blog/">Blog</a></li>' +
          '<li><a href="' + ROOT + 'glossario/">Glossário</a></li>' +
        '</ul>' +
      '</div>' +
      '<div class="footer__col">' +
        '<h4>Links úteis</h4>' +
        '<ul>' +
          ...
          '<li><a href="' + ROOT + 'politica-de-privacidade/">Política de privacidade</a></li>' +
        '</ul>' +
      '</div>' +
    '</div>' +
  '</div>' +
  '<div class="footer__strip"><div class="wrap footer__strip-in">' +
    ...
    '<div class="footer__eu">' +
      '<img src="' + '/assets/ivf-fondo.webp" alt="Financiado pela Generalitat Valenciana, IVF (Institut Valencià de Finances) e pela União Europeia" width="2238" height="403" loading="lazy" decoding="async"/>' +
    '</div>' +
  '</div></div>' +
  ...
  function initCookieBanner() {
    ...
    el.innerHTML =
      '<p class="cookie-banner__text">Utilizamos cookies próprios e de terceiros para melhorar a experiência e analisar a utilização do site. Podem ser aceites ou rejeitados. Mais informações na nossa <a href="' + ROOT + 'politica-de-cookies/">Política de Cookies</a>.</p>' +
      '<div class="cookie-banner__actions">' +
        '<button class="btn btn--secondary" type="button" data-cookie="reject">Rejeitar</button>' +
        '<button class="btn btn--primary" type="button" data-cookie="accept">Aceitar</button>' +
      '</div>';
