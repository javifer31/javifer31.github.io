...
(function () {
  ...
  '<header class="nav"><div class="wrap nav__in">' +
    ...
    '<ul class="nav__links">' +
      '<li class="nav__item">' +
        '<button class="nav__link" type="button">Produits <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M6 9l6 6 6-6"/></svg></button>' +
        '<div class="nav__menu">' +
          '<a href="' + ROOT + 'gestion-des-incidents/"><b>Incidents</b><span>Enregistrez, affectez et résolvez avec une clôture documentée</span></a>' +
          '<a href="' + ROOT + 'registres-et-controles/"><b>Enregistrements et audits</b><span>Contrôles, checklists et audits numériques</span></a>' +
          '<a href="' + ROOT + 'gestion-documentaire/"><b>Gestionnaire documentaire</b><span>Version en vigueur, dates d\'expiration et validation</span></a>' +
          '<a href="' + ROOT + 'actions-correctives/"><b>Tâches, actions et non-conformités</b><span>Actions correctives et suivi jusqu\'à la clôture</span></a>' +
          '<a href="' + ROOT + 'gestion-des-actifs/"><b>Actifs</b><span>Chaque machine avec sa fiche, son QR et son historique</span></a>' +
          '<a href="' + ROOT + 'tableaux-de-bord/"><b>KPI et tableaux de bord</b><span>Vision à 360º en temps réel et rapports automatiques</span></a>' +
          '<a href="' + ROOT + 'ia/"><b>IA</b><span>Interrogez vos données : la réponse cite le rapport</span></a>' +
        '</div>' +
      '</li>' +
      '<li class="nav__item">' +
        ...
        '<div class="nav__menu">' +
          '<a href="' + ROOT + 'industrie-manufacturiere/"><b>Industrie manufacturière</b><span>Fabrication et procédés</span></a>' +
          '<a href="' + ROOT + 'industrie-agroalimentaire/"><b>Industrie agroalimentaire</b><span>Sécurité et qualité alimentaires</span></a>' +
        '</div>' +
      '</li>' +
      ...
      '<li class="nav__item">' +
        '<a class="nav__link" href="' + ROOT + 'integrations/">Intégrations</a>' +
      '</li>' +
      '<li class="nav__item">' +
        '<button class="nav__link" type="button">Ressources <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M6 9l6 6 6-6"/></svg></button>' +
        '<div class="nav__menu">' +
          '<a href="' + ROOT + 'etudes-de-cas/"><b>Études de cas</b><span>Comment ils travaillent avec Solved, raconté par eux</span></a>' +
          '<a href="' + ROOT + 'blog/"><b>Blog</b><span>Articles et guides sur la qualité et l\'industrie</span></a>' +
          '<a href="' + ROOT + 'glossaire/"><b>Glossaire</b><span>Les termes de l\'industrie expliqués</span></a>' +
        '</div>' +
      '</li>' +
      '<li class="nav__cta-mobile"><a class="btn btn--primary" href="' + demo + '">Demander une démo</a></li>' +
    '</ul>' +
    '<a class="btn btn--primary nav__cta-desktop" href="' + demo + '">Demander une démo</a>' +
    '<button class="nav__toggle" type="button" aria-label="Ouvrir le menu" aria-expanded="false">' +
  ...
  '<footer class="footer"><div class="wrap">' +
    '<div class="footer__in">' +
      '<div class="footer__brand">' +
        ...
        '<iframe class="footer__map" src="https://maps.google.com/maps?q=Edificio%20Angels%2C%20Carrer%20del%20Port%2013%2C%2046024%20Valencia&z=16&output=embed" title="Emplacement de Solved — Edificio Angels, Valence" loading="lazy" referrerpolicy="no-referrer-when-downgrade" allowfullscreen></iframe>' +
      ...
      '<div class="footer__col">' +
        ...
        '<ul>' +
          ...
          '<li><a href="' + ROOT + 'registres-et-controles/">Enregistrements/Checklists</a></li>' +
          '<li><a href="' + ROOT + 'gestion-des-incidents/">Gestion des incidents</a></li>' +
          '<li><a href="' + ROOT + 'gestion-documentaire/">Gestionnaire documentaire</a></li>' +
          '<li><a href="' + ROOT + 'gestion-des-actifs/">Gestion des actifs</a></li>' +
          '<li><a href="' + ROOT + 'tableaux-de-bord/">Dashboard</a></li>' +
          '<li><a href="' + ROOT + 'ia/">IA</a></li>' +
          '<li><a href="' + ROOT + 'integrations/">Intégrations</a></li>' +
          '<li><a href="' + ROOT + 'etudes-de-cas/">Études de cas</a></li>' +
          '<li><a href="' + ROOT + 'blog/">Blog</a></li>' +
          '<li><a href="' + ROOT + 'glossaire/">Glossaire</a></li>' +
        '</ul>' +
      '</div>' +
      '<div class="footer__col">' +
        '<h4>Liens utiles</h4>' +
        '<ul>' +
          '<li><a href="' + ROOT + 'politique-de-cookies/">Politique de cookies</a></li>' +
          '<li><a href="' + ROOT + 'politique-de-confidentialite/">Politique de confidentialité</a></li>' +
        '</ul>' +
      '</div>' +
    '</div>' +
  '</div>' +
  '<div class="footer__strip"><div class="wrap footer__strip-in">' +
    ...
    '<div class="footer__eu">' +
      '<img src="' + '/assets/ivf-fondo.webp" alt="Financé par la Generalitat Valenciana, IVF (Institut Valencià de Finances) et l\'Union européenne" width="2238" height="403" loading="lazy" decoding="async"/>' +
    '</div>' +
  '</div></div>' +
  ...
  function initCookieBanner() {
    ...
    el.setAttribute('aria-label', 'Avis relatif aux cookies');
    el.innerHTML =
      '<p class="cookie-banner__text">Nous utilisons des cookies internes et tiers pour améliorer votre expérience et analyser l\'utilisation du site. Vous pouvez les accepter ou les refuser. Plus d\'informations dans notre <a href="' + ROOT + 'politique-de-cookies/">Politique de cookies</a>.</p>' +
      '<div class="cookie-banner__actions">' +
        '<button class="btn btn--secondary" type="button" data-cookie="reject">Refuser</button>' +
