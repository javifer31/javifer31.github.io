    ...
    '<ul class="nav__links">' +
      '<li class="nav__item">' +
        ...
        '<div class="nav__menu">' +
          ...
          '<a href="' + ROOT + 'gestor-documental/"><b>Gestor documental</b><span>Versión vigente, caducidades y validación</span></a>' +
          ...
          '<a href="' + ROOT + 'gestion-de-activos/"><b>Activos</b><span>Cada máquina con su ficha, su QR y su historial</span></a>' +
          '<a href="' + ROOT + 'dashboard/"><b>KPIs y dashboards</b><span>Visión 360º en tiempo real e informes automáticos</span></a>' +
          '<a href="' + ROOT + 'ia/"><b>IA</b><span>Pregunta a tus datos y contesta citando el parte</span></a>' +
        '</div>' +
      '</li>' +
      '<li class="nav__item">' +
      ...
      '<li class="nav__item">' +
        '<a class="nav__link" href="' + ROOT + 'integraciones/">Integraciones</a>' +
      '</li>' +
      '<li class="nav__item">' +
        ...
        '<div class="nav__menu">' +
          '<a href="' + ROOT + 'casos-de-exito/"><b>Casos de éxito</b><span>Cómo trabajan con Solved, contado por ellos</span></a>' +
